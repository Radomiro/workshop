...
public class WorkshopTestContainer extends TestContainer {

    public WorkshopTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/workshop/app.properties",
    ...
    public static class Common extends WorkshopTestContainer {

        public static final WorkshopTestContainer.Common INSTANCE = new WorkshopTestContainer.Common();
